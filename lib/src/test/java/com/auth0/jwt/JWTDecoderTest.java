...
public class JWTDecoderTest {
    ...
    private DecodedJWT customJWT(String jsonHeader, String jsonPayload, String signature) {
        String header = Base64Jwt.encodeBase64URLSafeString(jsonHeader.getBytes(StandardCharsets.UTF_8));
        String body = Base64Jwt.encodeBase64URLSafeString(jsonPayload.getBytes(StandardCharsets.UTF_8));
